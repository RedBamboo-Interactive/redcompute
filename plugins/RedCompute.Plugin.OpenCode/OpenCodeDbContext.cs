...
public class OpenCodeDbContext : DbContext
{
    ...
    private void MigrateSchema()
    {
        ...
        try
        {
            ...
            foreach (var col in new[] { "OpenCodeSessionId", "Effort", "QualityTier", "ProviderEntity", "RepositoryId", "Source", "UserId", "UserName", "UserAvatarUrl", "StopReason", "DeveloperInstructions" })
            {
