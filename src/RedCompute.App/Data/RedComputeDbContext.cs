...
public class RedComputeDbContext : DbContext
{
    ...
    public void MigrateSchema()
    {
        ...
        foreach (var col in new[] { ("Progress", "REAL"), ("ResultJson", "TEXT"), ("Name", "TEXT"), ("Rationale", "TEXT"), ("CostUsd", "REAL"), ("CallerInfo", "TEXT"), ("IdempotencyKey", "TEXT"), ("UserId", "TEXT"), ("UserName", "TEXT"), ("UserAvatarUrl", "TEXT") })
        {
